...
// 动态加载内容区域
/*
 * function addContent(obj) { var address = $(this).attr('url');
...
/*******************************************************************************
 * 提交一个get请求 例子: <button onClick="deleteCheck(this);" id="staff_delete.action"
 * id="stafffind.action">删除</button> id -deleteAction地址 callback -删除成功回调页面地址
 * *********************
 */
...
/*******************************************************************************
 * 删除一条或者多条数据(通用方法) 例子: <button onClick="deleteCheck(this);"
 * id="staff_delete.action" id="stafffind.action">删除</button> id
 * -deleteAction地址 callback -删除成功回调页面地址 *********************
 */
...
/*******************************************************************************
 * 刷新页面(内部JS调用方法) url -刷新地址 title - 地址标题（面包屑导航） *******************
 */
...
/*
 * 刷新表格 参数 obj为tr对象 参数 over为boolean值
 */
